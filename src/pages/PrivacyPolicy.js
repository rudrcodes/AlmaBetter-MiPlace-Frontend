...
function PrivacyPolicy() {
  return (
    <div className=" h-full w-full flex justify-center items-center p-4 font-mullish">
      <div className=" w-10/12">
        <p className="text-3xl text-bold">Privacy Policy</p>
        <p className="m-2">
          ...
          in felis sed leo vestibulum venenatis.{" "}
        </p>
        <p className="m-2">
          Rorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu
          turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec
