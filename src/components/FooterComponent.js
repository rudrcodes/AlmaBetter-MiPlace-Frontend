...
const FooterComponent = () => {
  return (
    <div className="p-3 relative flex justify-center items-center font-mullish ">
      <div className="  flex justify-between items-center  w-11/12 h-full	">
        <div className="left w-2/5 text-start	 space-y-4">
          ...
          <span>
            <span className="flex mt-3 font-bold text-xl">
              Made by-
              <a
                className="flex font-semibold"
                href="https://www.linkedin.com/in/arul-j-812680132/"
              >
                {" "}
                ARUL Johnson
              </a>
              ...
              & <span className="flex font-semibold"> Sejal Goyal</span>
            </span>
          </span>
        </div>
